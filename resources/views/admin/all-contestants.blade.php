...
<!-- /.sidebar -->
 ...
 <div class="content-wrapper">
    ...
    <section class="content container-fluid">
      ...
      <div>
        <form action="{{route('admin.all-contestants')}}" method="post">
        @csrf
            <div class="row">
                <div class="col-md-3">
                        <div class="form-group">
                            <select name="search_month" id="" class="form-control">
                                <option value="{{date('F')}}" default>{{date('F')}}</option>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        <button type="submit" class="form-control btn btn-primary">Paid</button>
                    </div>
                </div>
            </div>
        </form>
